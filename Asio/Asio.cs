...
namespace Asio
{
    ...
    class AsioObject : IDisposable
    {
        ...
        class VTable
        {
            ...
            [UnmanagedFunctionPointer(CallingConvention.ThisCall)] public delegate ASIOError _getClockSources(IntPtr _this, ASIOClockSource[] clocks, out int numSources);
