    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            Dictionary<Expression, Expression> Tests = new Dictionary<Expression, Expression>()
            {
                ...
                // NSolve.
                { "NSolve[x == Cos[x], x->0.5, 4]", "x->0.739085" },
                { "NSolve[2 == Exp[x] - Exp[-x], x->0.5, 4]", "x->0.881374" },
                { "NSolve[{y == x^2, x^2 + y^2 == 1}, {x->1, y->1}, 4]", "{x->0.786, y->0.618}" },
                { "NSolve[{y == x^2, x^2 + y^2 == 1, z == x + y}, {x->1, y->1, z->1}, 4]", "{x->0.786, y->0.618, z->1.386}" },
                { "NSolve[{z == x^2, x^2 + y^2 == 1, z == y}, {x->1, y->1, z->1}, 4]", "{x->0.786, y->0.618, z->0.618}" },
                { "NSolve[{Exp[x + y] == 1, Exp[x - 2*y] == 2}, {x->0.5, y->0.5}, 4]", "{x->0.1505, y->-0.1505}" },
                { "NSolve[(((0.01*Vo) + (-0.01*1) + (1E-12*Exp[(38.6847*Vo)]) + (-1E-12*Exp[(-38.6847*Vo)]))==0), Vo->0.57, 4]", "Vo->0.573208" },
                { "NSolve[(((0.01*Vo) + (-0.01*1) + (1E-12*Exp[(38.6847*Vo)]) + (-1E-12*Exp[(-38.6847*Vo)]))==0), Vo->0, 4]", "Vo->0.573208" },
                { "NSolve[(Ln[((0.01*Vo) + (1E-12*Exp[(38.6847*Vo)]) + (-1E-12*Exp[(-38.6847*Vo)]))]==Ln[0.01]), Vo->0.01, 4]", "Vo->0.573208" },
