    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            Dictionary<Expression, Expression> Tests = new Dictionary<Expression, Expression>()
            {
                ...
                { "NSolve[{y == x^2, x^2 + y^2 == 1, z == x + y}, {x->1, y->1, z->1}]", "{x->0.786, y->0.618, z->1.386}" },
                { "NSolve[{z == x^2, x^2 + y^2 == 1, z == y}, {x->1, y->1, z->1}]", "{x->0.786, y->0.618, z->0.618}" },
                { "NSolve[{Exp[x + y] == 1, Exp[x - 2*y] == 2}, {x->0.5, y->0.5}]", "{x->0.1505, y->-0.1505}" },
            ...
            System.Console.WriteLine("{0} of {1} passed", passed, Tests.Count);
