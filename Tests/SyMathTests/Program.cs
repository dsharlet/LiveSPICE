    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            Dictionary<Expression, Expression> Tests = new Dictionary<Expression, Expression>()
            {
                ...
                // NSolve.
                { "NSolve[x == Cos[x], x->0.5, 4]", "0.739085" },
                { "NSolve[2 == Exp[x] - Exp[-x], x->0.5, 4]", "0.881374" },
                { "NSolve[{y - x^2 == 0, x^2 + y^2 - 1 == 0}, {x->1, y->1}, 4]", "{x->0.786, y->0.618}" },
                { "NSolve[(((0.01*Vo) + (-0.01*1) + (1E-12*Exp[(38.6847*Vo)]) + (-1E-12*Exp[(-38.6847*Vo)]))==0), Vo->0.57, 4]", "0.573208" },
                { "NSolve[(((0.01*Vo) + (-0.01*1) + (1E-12*Exp[(38.6847*Vo)]) + (-1E-12*Exp[(-38.6847*Vo)]))==0), Vo->0, 4]", "0.573208" },
                { "NSolve[(Ln[((0.01*Vo) + (1E-12*Exp[(38.6847*Vo)]) + (-1E-12*Exp[(-38.6847*Vo)]))]==Ln[0.01]), Vo->0.01, 4]", "0.573208" },
