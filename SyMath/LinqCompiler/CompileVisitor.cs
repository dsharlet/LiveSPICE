...
namespace SyMath.LinqCompiler
{
    ...
    class CompileVisitor : ExpressionVisitor<LinqExpr>
    {
        ...
        protected override LinqExpr VisitVariable(Variable V) { throw new InvalidOperationException("Undefined variable '" + V.Name + "'."); }
        protected override LinqExpr VisitUnknown(Expression E) { throw new NotImplementedException("Unsupported expression type."); }
