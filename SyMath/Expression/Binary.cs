...
namespace SyMath
{
    public class Binary : Expression
    {
        ...
        static public Binary Substitute(Expression L, Expression R) { return SyMath.Substitute.New(L, R); }
        static public Binary Equal(Expression L, Expression R) { return SyMath.Equal.New(L, R); }
